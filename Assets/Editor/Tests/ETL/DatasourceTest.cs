...
namespace Assets.Editor.Tests.ETL
{
    public class DatasourceTest
    {
        ...
        public void TestTransform()
        {
            ...
            Assert.AreEqual(dataset.fields[2].name, "INSERT_ID");
            Assert.AreEqual(dataset.fields[2].type, Datatype.STRING);
            Assert.AreEqual(dataset.lines[0][2], "2900012023010112");
        }
    }
}