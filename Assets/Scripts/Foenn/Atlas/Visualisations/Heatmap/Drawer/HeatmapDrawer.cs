...
namespace Assets.Scripts.Foenn.Atlas.Visualisations.Heatmap
{
    ...
    {
        internal static Color32[] ColorizeAverageGrid(TemperatureGrid grid, RenderSettings render, HeatmapSettings settings, HeatmapDrawerSettings rawImageSettings, Color32[] maskPixels = null)
        {
