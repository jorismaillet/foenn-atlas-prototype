...
namespace Assets.Scripts.Components.Visualisations.Heatmap.Render
{
    ...
    {
        public static float LonToX(float lon, RenderSettings settings)
        {
        ...
        public static float LatToY(float lat, RenderSettings settings)
        {
        ...
        public static Color32[] ReadMaskPixels(Texture2D mapMask, RenderSettings settings)
        {
        ...
        public static Texture2D CreateTexture(Color32[] pixels, RenderSettings settings)
        {
