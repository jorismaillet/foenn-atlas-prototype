...
namespace Assets.Scripts.OLAP.Schema.Fields
{
    public class Field
    {
        ...
        //Geo attributes
        public static Field GeoLatAttribute(string tableName, string fieldName) => new Field(tableName, fieldName, DbType.Single, AnalyticsType.ATTRIBUTE) { analyticsType = AnalyticsType.GEO_LAT };
        public static Field GeoLonAttribute(string tableName, string fieldName) => new Field(tableName, fieldName, DbType.Single, AnalyticsType.ATTRIBUTE) { analyticsType = AnalyticsType.GEO_LON };
